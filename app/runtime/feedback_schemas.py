...
def _plan_task_output_is_executable(task: dict[str, Any]) -> bool:
    ...
    if execution_kind == "external_webhook":
        return _task_context_has_external_specificity(_normalize_task_context_payload(task.get("task_context")))
    return False
...
def _task_context_has_external_specificity(context: dict[str, Any]) -> bool:
