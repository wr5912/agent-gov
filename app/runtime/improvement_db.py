...
class AttributionModel(Base):
    ...
    counter_evidence_json: Mapped[list[str]] = mapped_column(JSON, default=list)
    uncertainty_factors_json: Mapped[list[str]] = mapped_column(JSON, default=list)
...
class ExecutionRecordModel(Base):
    ...
    rollback_instructions_json: Mapped[list[str]] = mapped_column(JSON, default=list)
    status: Mapped[str] = mapped_column(String(32), default="draft")
    generated_by: Mapped[str] = mapped_column(String(32), default="heuristic")
