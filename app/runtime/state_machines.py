...
_TRANSITIONS: Mapping[str, Mapping[str, set[str]]] = {
    ...
    "batch": {
        ...
        "attribution_completed": {"optimization_plan_queued", "pending_execution", "needs_human_review"},
        "attribution_failed": {"attribution_running", "needs_human_review"},
        "optimization_plan_queued": {"pending_execution", "needs_human_review", "failed"},
        ...
        "completed": set(),
        "blocked": {"pending_execution", "optimization_plan_queued", "needs_human_review"},
        "sent": {"notification_failed", "pending_execution", "execution_planning"},
        "notification_failed": {"sent", "pending_execution", "execution_planning", "needs_human_review"},
        "pending_execution": {
            "draft",
            "optimization_plan_queued",
            "execution_planning",
