...
try:
    ...
    raise SystemExit("Missing dependency: pip install -r /workspace/mcp_servers/requirements.txt") from exc

mcp = FastMCP("soc-data")


def _load_alerts() -> list[dict[str, Any]]:
    sample = Path(os.getenv("SOC_SAMPLE_DATA", "/workspace/mcp_servers/soc_data_mcp/sample_alerts.json"))
    if sample.exists():
