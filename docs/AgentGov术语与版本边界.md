...
3. 下一大版本 v2.7 规划，例如 `AgentGov_ASCII_UI_草图方案_v2.7.md` 和对应设计一致性报告。
...
| 下一大版本 v2.7 规划 | `AgentGov_ASCII_UI_草图方案_v2.7.md`、v2.7 UI 设计一致性报告 | 使用 v2.7 统一术语，不再延续旧用户主流程名称 | 属于规划权威，不能替代当前实现基线 |
...
1. 写长期产品、目标愿景、v2.7 规划、用户主流程时，优先使用第 3 节统一术语。
