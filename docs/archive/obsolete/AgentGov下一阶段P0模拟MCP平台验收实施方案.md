...
> 归档说明（2026-09-09）：本文验证的是旧 Claude Runtime 的合成 MCP slice，不能作为当前
> AgentScope Runtime 能力或部署验收依据。当前 MCP Harness、原生事件和容器验收以根
> `README.md`、`docs/AgentGov集成指南.md` 和公开 Make targets 为准。
