...
> 归档说明（2026-09-09）：旧 P2A 已被 AgentScope Runtime 原子切换取代，不是当前或下一阶段
> 实施入口。当前契约见根 `README.md` 与 `docs/AgentGov集成指南.md`。
>
> 文档状态：评审稿。
>
...
>
> 并行关联：[P1 网络安全测评纵向闭环实施方案](../../engineering/AgentGov下一阶段P1网络安全测评纵向闭环实施方案.md)。
> P1 与 P2A 曾共同以 [P0 准入收口实施方案](./AgentGov下一阶段P0准入收口实施方案.md) 为上游，
