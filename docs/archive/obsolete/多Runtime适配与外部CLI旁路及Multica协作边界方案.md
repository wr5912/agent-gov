...
> 归档说明（2026-09-09）：本文基于旧 Claude 生产 Runtime 形成，已被 AgentScope Runtime 原子
> 切换取代，不再是当前或下一阶段架构入口，仅保留审计价值。
>
...
当前产品边界以 [项目目标愿景使命](../../项目目标愿景使命.md)、[AgentGov 术语与版本边界](../../AgentGov术语与版本边界.md)、当前 OpenAPI 和代码为准；本文不得作为实施依据。
