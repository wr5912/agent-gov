...
${HOST_RUNTIME_VOLUME_ROOT}/data/.runtime-tmp/jobs/
...
/data/runtime.sqlite3 + /data/.runtime-tmp/jobs + main-workspace Git + /data/agent-governance
  = 反馈闭环的权威数据、临时任务工作区、版本记录和候选/发布资产。
```
