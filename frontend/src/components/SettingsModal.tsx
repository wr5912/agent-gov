  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-card settings-panel" data-testid="settings-panel">
        ...
        <section className="settings-section" data-testid="settings-section-automation">
          <h4>自动化策略</h4>
        ...
        <section className="settings-section" data-testid="settings-section-assets">
          <h4>资产 Registry</h4>
        ...
        <section className="settings-section" data-testid="settings-section-developer">
          <h4>Developer / Debug</h4>
          ...
          <div className="settings-developer-links">
            ...
            <button className="secondary-button" data-testid="settings-open-feedback" onClick={() => { onOpenFeedback(); onClose(); }}>反馈优化工作台（旧 / 诊断）</button>
          </div>
        </section>
