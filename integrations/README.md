...
面向用 Claude Code / Codex 开发的上层业务系统：把 `agentgov-claude-skill/SKILL.md` 复制到你们项目的 `.claude/skills/agentgov-integration/SKILL.md`（或 Codex 对应 `.codex/skills/...`），集成方的开发 Agent 即可掌握集成 AgentGov 的旅程与硬边界。
