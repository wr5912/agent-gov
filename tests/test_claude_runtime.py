...
def test_stream_ag_ui_ignores_legacy_a2ui_tools_after_removal(tmp_path, monkeypatch):
    from claude_agent_sdk import ResultMessage
            ...
            "content": [
                {
                    ...
                    "input": {
                        "messages": [
                            {"beginRendering": {"surfaceId": "legacy-surface", "root": "legacy-root"}}
                        ]
                    },
                }
            ],
